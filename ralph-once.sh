...
IMPORTANT: Read the SCOPE GUARDRAILS section first. Do NOT add features or work outside PRD scope. \
1. Read the PRD and progress file. \
2. Find the next incomplete task (first unchecked [ ] item). \
3. Implement ONLY what the task specifies - no extras. \
...
ONLY DO ONE TASK. NO SCOPE CREEP. If blocked, skip to next task."
